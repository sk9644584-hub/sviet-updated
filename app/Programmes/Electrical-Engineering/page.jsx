...
const programmes = [
    {
        ...
        psos: [
            "<strong>PEO1:</strong> To train the students of Electrical Engineering program so that they can work with government or private sector companies responsible for development of power sector & prove themselves in electrical maintenance for the industry.",
            "<strong>PEO2:</strong> To train students of Electrical Engineering program who can contribute to teaching profession, research & development by pursuing higher studies.",
            "<strong>PEO3:</strong> To train students of Electrical Engineering program in a manner that they should function effectively in the multicultural and multidisciplinary groups in their practice of Electrical Engineering profession."
        ],
        psos: [
            "<strong>PSO1:</strong> Graduates will demonstrate their knowledge in effective implementation during their practice of profession of Electrical Engineering with due regard to environment and social concerns.",
            "<strong>PSO2:</strong> Graduates will demonstrate their knowledge in analysis, design, erection and laboratory experimentation regarding Electrical Engineering.",
            "<strong>PSO3:</strong> Graduates will be motivated for continuous self learning in engineering practice and pursue research in advanced areas of Electrical Engineering in order to offer engineering services to the society, ethically."
        ]
